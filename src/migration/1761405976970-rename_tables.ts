...
export class RenameTables1761405976970 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_token" DROP CONSTRAINT IF EXISTS "FK_8e913e288156c133999341156ad"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refreshTokens" DROP CONSTRAINT IF EXISTS "FK_265bec4e500714d5269580a0219"`);
